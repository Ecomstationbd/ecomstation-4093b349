...
export default function Auth() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    if (method === "phone") {
      ...
      const okPass = z.string().min(6).max(100).safeParse(password).success;
      if (!okPass) { toast.error(bn ? "পাসওয়ার্ড ৬+ অক্ষর দিন" : "Password 6+ chars required"); return; }
      setBusy(true);
      if (mode === "signup") {
          ...
          <>
            ...
            <Button variant="outline" className="w-full" onClick={google}>
              <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.33v2.77h3.56c2.08-1.92 3.28-4.74 3.28-8.11z" fill="#4285F4"/>
